program Heat_equation_2D
    ...
    integer:: ny , nx , nz, ierr, rank, nprocs
    ...
    print*, "Each processor work on" , nprocs, "Processes"

    if(rank == 0) then 
        data0 = 100
        call MPI_SEND(data0, 1, MPI_INT, 1,1, MPI_COMM_WORLD,ierr)
        print*, "Rank", rank, "recieved data1 from rank 1 as data0="
    ...
    if(rank == 1) then
        ...
        print*, "Rank", rank, "Received data0 from rank0="
